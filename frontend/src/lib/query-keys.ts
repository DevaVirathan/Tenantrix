export const queryKeys = {
  ...
  projectStates: (orgId: string, projectId: string) =>
    ["org", orgId, "project", projectId, "states"] as const,
  watchers: (orgId: string, taskId: string) =>
    ["org", orgId, "task", taskId, "watchers"] as const,
